    ...
    <>
      ...
      `}>
        ...
        <nav className="flex-1 py-6 space-y-1 overflow-y-auto">
          ...
          <SidebarItem icon={CalendarIcon} label="Archives" active={activeTab === 'Archives'} to="/archives" />
          <SidebarItem icon={FileText} label="Regenerasi" active={activeTab === 'Regenerasi'} to="/regenerasi" />
        </nav>
      </div>
    </>
  );
